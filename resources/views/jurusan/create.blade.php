                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="jurusan" class="form-control @error('jurusan') is-invalid @enderror " id="nama jurusan" placeholder="Isi Jurusan">
                                @error('jurusan')
                        ...
                        <button type="submit" name="simpan" class="btn btn-primary mr-3" style="width: 150px; padding: 12px; background: #337ab7; border: none;">Save</button>
